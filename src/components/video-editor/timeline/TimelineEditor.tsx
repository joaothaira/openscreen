...
export default function TimelineEditor({
	...
	const hasOverlap = useCallback(
		...
		[zoomRegions, trimRegions, annotationRegions, speedRegions, webcamFocusRegions, webcamSegments],
	);
	...
	const timelineItems = useMemo<TimelineRenderItem[]>(() => {
		...
		return [...zooms, ...trims, ...annotations, ...speeds, ...webcamFocuses, ...webcamSegmentItems];
	}, [zoomRegions, trimRegions, annotationRegions, speedRegions, webcamFocusRegions, webcamSegments, t]);
